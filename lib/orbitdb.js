...
class OrbitDB {
  ...
  // Event handler for when a peer publishes a message to this peers Receive DB.
  ...
  async sendToDb (peerId, str, orbitdbId) {
    try {
      ...
      console.log('sendToDb() orbitdbId: ', orbitdbId)
      ...
      console.error('Error in orbitdb.js/sendToDb(): ', err)
      throw err
    }
  }
  ...
  _getTimestamp () {
    try {
      ...
      console.error('Error in orbitdb.js/_getTimestamp()')
      throw err
    }
  }
}
